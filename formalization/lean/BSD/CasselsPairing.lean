...
axiom sha2_dimension (E : Type) : ℕ

/-- The dimension is always even due to Cassels pairing -/
axiom sha2_dimension_even (E : Type) : Even (sha2_dimension E)
